...
SP.Changelog = {
    ...
    ["2.6.3"] = {
        { type = "fix", text = "The movement alert comes up at the size you set it, without needing the options window opened once per session." },
    },
    ["2.6.1"] = {
    ...
    ["2.5.4"] = {
        { type = "fix", text = "The Bloodlust alert works again on patch 12.1, and stops throwing an error on every buff or debuff you gain." },
    },
